...
- A 13. modul (Iteráció) után a 20. bónusz építő-modul jön — hogyan készítettem el ezt a kurzust (videókurzus AI-vágással).
...
A 4 fázis mérföldkő-nevet kapott: nem azt mondja, mit csinálsz, hanem mit fogsz tudni a végén. 3 checkpoint-nál ellenőrzöd, hogy minden megvan-e, mielőtt továbbmész.
...
- **Ügyfél**: 12 hét után 1-3 fizető (saját hálózatból, ajánlásból — 8. modul).
- **Bevétel**: első év 500-1500 ezer Ft (idő- és árazási sávtól függ).
- **Költség**: 50-100 ezer Ft / év — VS Code ingyenes, Claude Code (~$20/hó ≈ 7-8.000 Ft), Google Workspace (~2.000 Ft/hó), Sybell domain (~3-5.000 Ft/év), Vercel és Kit (1000 feliratkozóig) ingyenes.
- Ez nem gyors-meggazdagodás-kurzus — alap-rendszer, amire 2-3. évben építhetsz.
...
- **Google Analytics 4** (ingyenes), **Google Sheets** (Workspace része)
