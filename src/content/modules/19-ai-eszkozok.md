...
- 2:00 — 6.2 Landing page generátor skill
- 3:00 — 6.3 Lead magnet generátor skill
- 4:00 — 6.4 CRM dashboard generátor skill
- 5:00 — 6.5 Content pipeline skill
...
3. **Lead magnet generátor** — Markdown → PDF, pandoc-kal
4. **CRM dashboard generátor** — Google Sheets formula-tervező
